...
return array(
	...
	'interface' => array(
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, name, imap_folder',
	),
	'types' => array(
		'1' => array('showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, hidden;;1, name, imap_folder, --div--;LLL:EXT:cms/locallang_ttc.xlf:tabs.access, starttime, endtime'),
	),
	'palettes' => array(
		'1' => array('showitem' => ''),
	),
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table' => 'tx_t3fxmailscanner_domain_model_sender',
				'foreign_table_where' => 'AND tx_t3fxmailscanner_domain_model_sender.pid=###CURRENT_PID### AND tx_t3fxmailscanner_domain_model_sender.sys_language_uid IN (-1,0)',
			),
		),
