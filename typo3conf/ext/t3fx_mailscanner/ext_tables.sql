#
# Table structure for table 'tx_t3fxmailscanner_domain_model_mailscanner'
#
CREATE TABLE tx_t3fxmailscanner_domain_model_mailscanner (

	uid int(11) NOT NULL auto_increment,
	pid int(11) DEFAULT '0' NOT NULL,

	imap_folder int(11) unsigned DEFAULT '0' NOT NULL,
